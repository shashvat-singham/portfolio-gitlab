...
const talkSection = {
  ...
  talks: [
    ...
    // ,
    // {
    //   title: "Show Management: TOSC, Take Off, Fintech ",
    //   subtitle: "Techkriti, Asia's Largest Technical and Enterpreneural Fest @IITK ",
    //   // slides_url: "https://drive.google.com/drive/folders/1DEYKxLcY1No8pD1H70jfjK15IYHciywm?usp=sharing",
    //   event_url: "https://techkriti.org/"
    // }
  ],
  display: true // Set false to hide this section, defaults to true
};
...
const podcastSection = {
  ...
  podcast: [
    "https://anchor.fm/ shashvat-singham/embed/episodes/Quantum-Odyssey-From-the-Ordinary-to-the-Extraordinary-e297s2t","https://anchor.fm/ shashvat-singham/embed/episodes/JK-Rowling-Harvard-Commencement-Speech-e29736n/a-aabhnbm"
  ],
  display: true // Set false to hide this section, defaults to true
};
